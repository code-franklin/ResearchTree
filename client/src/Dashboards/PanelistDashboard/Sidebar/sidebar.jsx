  ...
  return (
    <div className="sidebar z-1 h-screen w-[313px] bg-[#1E1E1E] text-white flex flex-col fixed">
      ...
      <UserAvatar/>
        ...
        <p className="font-light text-[#4B4B4B]">Panelist</p>
        </div>
      ...
      <div className="mr-5 mt-[30px] space-y-2 text-[20px] ">
        ...
        <Link to="PanelistDashboard/Publishing"
        ...
        <Link to="PanelistDashboard/ExploreManuscript" 
        ...
        <Link to="PanelistDashboard/ViewAnalytics"
