...
var ChartHelper = /** @class */ (function (_super) {
    ...
    ChartHelper.prototype.createInstance = function (config) {
        ...
        this.key = (0, unique_id_1.default)('bx-chart');
    ...
    ChartHelper.prototype.onGetG2Instance = function () {
        ...
        if ((0, is_function_1.default)(this.config.onGetG2Instance)) {
    ...
    ChartHelper.prototype.shouldReCreateInstance = function (newConfig) {
        ...
        if ((0, is_array_1.default)(this.config.data)
            && preData.length === 0
            && (0, is_array_1.default)(data)
            && data.length !== 0) {
            return true;
        }
        // scale 切换不需要重建实例
        var unCompareProps = __spreadArray(__spreadArray([], constant_1.REACT_PIVATE_PROPS, true), ['scale', 'width', 'height', 'container', '_container', '_interactions', 'placeholder', /^on/, /^\_on/], false);
        if (!(0, is_equal_1.default)((0, pickWithout_1.default)(preOptions, __spreadArray([], unCompareProps, true)), (0, pickWithout_1.default)(options, __spreadArray([], unCompareProps, true)))) {
            return true;
        }
        return false;
    };
    ChartHelper.prototype.update = function (props) {
        var _this = this;
        var newConfig = (0, cloneDeep_1.default)(this.adapterOptions(props));
        ...
        // 事件
        var events = (0, events_1.pickEventName)(this.config);
        var newEvents = (0, events_1.pickEventName)(newConfig);
        // 配置
        ...
        // 数据 更新
        if ((0, is_array_1.default)(preData) && preData.length) {
            // 数据只做2级浅比较
            // fixme: 做4级比较
            var isEqual_1 = true;
        ...
        // filter
        (0, each_1.default)(this.config.filter, function (it, index) {
            // 销毁
            if ((0, is_array_1.default)(it)) {
        ...
        (0, each_1.default)(newConfig.filter, function (it, index) {
            if ((0, is_array_1.default)(it)) {
    ...
    ChartHelper.prototype.adapterOptions = function (_a) {
        ...
        // 剔除 React 自身的属性
        var options = (0, pickWithout_1.default)(others, __spreadArray([], constant_1.REACT_PIVATE_PROPS, true));
        if (options.forceFit) {
            (0, warning_1.default)(false, 'forceFit 已废弃，请使用`autoFit`替代');
        }
