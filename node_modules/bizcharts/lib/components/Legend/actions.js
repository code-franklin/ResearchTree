...
(0, core_1.registerAction)('list-active', list_active_1.default);
(0, core_1.registerAction)('list-selected', list_selected_1.default);
(0, core_1.registerAction)('list-highlight', list_highlight_1.default);
(0, core_1.registerAction)('list-unchecked', list_unchecked_1.default);
// 筛选数据
(0, core_1.registerAction)('data-filter', filter_1.default);
(0, core_1.registerAction)('legend-item-highlight', list_highlight_1.default, {
    componentNames: ['legend']
});
(0, core_1.registerInteraction)('legend-active', {
...
(0, core_1.registerInteraction)('legend-highlight', {
...
(0, core_1.registerInteraction)('legend-filter', {
    showEnable: [
