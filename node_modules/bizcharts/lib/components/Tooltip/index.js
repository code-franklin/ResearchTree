...
require("./actions");
(0, core_1.registerComponentController)('tooltip', tooltip_1.default);
var isReactTooltip = function (props) {
    var _a = props.visible, visible = _a === void 0 ? true : _a, children = props.children;
    return visible && (0, is_function_1.default)(children);
};
var TooltipNormal = function (props) {
    ...
    var chartView = (0, useChartView_1.default)();
...
function Tooltip(props) {
    ...
    var connectorId = (0, react_1.useRef)((0, unique_id_1.default)('tooltip'));
    // tooltip 联动
    (0, react_1.useEffect)(function () {
        if ((0, is_array_1.default)(linkage)) {
            (0, createTooltipConnector_1.registerConnector)(linkage[0], connectorId.current, chartView, options.shared, linkage[1]);
        }
        else if ((0, is_string_1.default)(linkage)) {
            (0, createTooltipConnector_1.registerConnector)(linkage, connectorId.current, chartView, options.shared);
        }
    }, [linkage, chartView]);
    var showFnc = (0, react_1.useCallback)(function (ITooltipEvent) {
        if ((0, is_function_1.default)(onShow)) {
            onShow(ITooltipEvent, chartView);
        }
    }, []);
    var changeFnc = (0, react_1.useCallback)(function (ITooltipEvent) {
        if ((0, is_function_1.default)(onChange)) {
            onChange(ITooltipEvent, chartView);
        }
    }, []);
    var hideFnc = (0, react_1.useCallback)(function (ITooltipEvent) {
        if ((0, is_function_1.default)(onHide)) {
