...
(0, core_1.registerGeometryLabel)('interval', interval_1.default);
(0, core_1.registerGeometryLabel)('pie', pie_1.default);
(0, core_1.registerGeometryLabel)('polar', polar_1.default);
(0, core_1.registerGeometryLabelLayout)('overlap', overlap_1.overlap);
(0, core_1.registerGeometryLabelLayout)('distribute', distribute_1.distribute);
(0, core_1.registerGeometryLabelLayout)('fixed-overlap', overlap_1.fixedOverlap);
(0, core_1.registerGeometryLabelLayout)('limit-in-shape', limit_in_shape_1.limitInShape);
(0, core_1.registerGeometryLabelLayout)('limit-in-canvas', limit_in_canvas_1.limitInCanvas);
function Label(props) {
    var parentInstance = props.parentInstance, content = props.content, cfg = __rest(props, ["parentInstance", "content"]);
    (0, warning_1.default)(false, 'Label组件即将被取消，请使用图形组件的label属性进行配置');
