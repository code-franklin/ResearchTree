...
(0, core_1.registerAction)('cursor', cursor_1.default);
(0, core_1.registerAction)('element-active', active_1.default);
(0, core_1.registerAction)('element-single-active', single_active_1.default);
(0, core_1.registerAction)('element-range-active', range_active_1.default);
(0, core_1.registerAction)('element-highlight', highlight_1.default);
(0, core_1.registerAction)('element-highlight-by-x', highlight_by_x_1.default);
(0, core_1.registerAction)('element-highlight-by-color', highlight_by_color_1.default);
(0, core_1.registerAction)('element-single-highlight', single_highlight_1.default);
(0, core_1.registerAction)('element-range-highlight', range_highlight_1.default);
(0, core_1.registerAction)('element-sibling-highlight', range_highlight_1.default, {
    effectSiblings: true,
    effectByRecord: true
});
(0, core_1.registerAction)('element-selected', selected_1.default);
(0, core_1.registerAction)('element-single-selected', single_selected_1.default);
(0, core_1.registerAction)('element-range-selected', range_selected_1.default);
(0, core_1.registerAction)('element-link-by-color', link_by_color_1.default);
// 移动到 elment 上 active
(0, core_1.registerInteraction)('element-active', {
    start: [{ trigger: 'element:mouseenter', action: 'element-active:active' }],
    end: [{ trigger: 'element:mouseleave', action: 'element-active:reset' }],
});
// 点击选中，允许取消
(0, core_1.registerInteraction)('element-selected', {
    start: [{ trigger: 'element:click', action: 'element-selected:toggle' }],
});
// hover highlight，允许取消
(0, core_1.registerInteraction)('element-highlight', {
    start: [{ trigger: 'element:mouseenter', action: 'element-highlight:highlight' }],
    end: [{ trigger: 'element:mouseleave', action: 'element-highlight:reset' }],
});
// hover highlight by x，允许取消
(0, core_1.registerInteraction)('element-highlight-by-x', {
...
(0, core_1.registerInteraction)('element-highlight-by-color', {
