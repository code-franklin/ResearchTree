...
exports.default = (0, createPlot_1.default)(bar_1.Bar, 'GroupedBarChart', function (props) {
    (0, warning_1.default)(false, '<GroupedBarChart /> 在5.0后即将被废弃，请使用<BarChart /> 替代');
    var _a = (0, polyfill_1.polyfillOptions)(props), barSize = _a.barSize, options = __rest(_a, ["barSize"]);
    (0, polyfill_1.replaceApi)(REPLACEAPILIST, options);
    if (!(0, util_1.isNil)(barSize)) {
        options.minBarWidth = barSize;
        options.maxBarWidth = barSize;
    }
    (0, util_2.deepMix)(props, {
        isGroup: true,
    });
    return options;
});
