...
var polyfill = function (opt) {
    (0, warning_1.default)(false, '<GroupedRose /> 即将在5.0后废弃，请使用<Rose />。');
    var options = (0, polyfill_1.polyfillOptions)(opt);
    (0, polyfill_1.replaceApi)(REPLACEAPILIST, options);
    if ((0, util_1.get)(options, 'label.type') === 'inner') {
        options.label.offset = -15;
        delete options.label.type;
    }
    if ((0, util_1.get)(options, 'label.type') === 'outer') {
        delete options.label.type;
    }
    return __assign(__assign({}, options), { isGroup: true });
};
exports.default = (0, createPlot_1.default)(rose_1.Rose, 'GroupedRoseChart', polyfill);
