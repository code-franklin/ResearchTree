...
exports.default = (0, createPlot_1.default)(heatmap_1.Heatmap, 'HeatmapChart', function (props) {
    var _a = (0, polyfill_1.polyfillOptions)(props), shapeType = _a.shapeType, options = __rest(_a, ["shapeType"]);
    if (shapeType) {
        options.heatmapStyle = shapeType;
        (0, warning_1.warn)(false, 'shapeType是g2plot@1.0的属性，即将废弃，请使用 `heatmapStyle` 替代');
    }
