...
exports.default = (0, createPlot_1.default)(liquid_1.Liquid, 'LiquidChart', function (opt) {
    ...
    if (!(0, util_1.isNil)(value)) {
        ...
        var formatter_1 = (0, util_1.get)(options, 'statistic.content.formatter');
    ...
    (0, polyfill_1.polyfillVisible)(options, 'statistic');
    (0, polyfill_1.polyfillVisible)(options, 'statistic.title');
    (0, polyfill_1.polyfillVisible)(options, 'statistic.content');
