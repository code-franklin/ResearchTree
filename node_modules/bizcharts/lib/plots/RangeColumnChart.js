...
;
exports.default = (0, createPlot_1.default)(column_1.Column, 'RangeColumnChart', function (props) {
    (0, warning_1.default)(false, '<RangeColumnChart /> 即将在5.0后废弃，请使用<ColumnChart />替代。');
