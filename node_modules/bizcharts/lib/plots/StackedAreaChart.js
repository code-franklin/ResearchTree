...
exports.default = (0, createPlot_1.default)(area_1.Area, 'StackedAreaChart', function (props) {
    (0, warning_1.default)(false, '<StackedAreaChart /> 即将在5.0后废弃，请使用<AreaChart /> 替代。');
