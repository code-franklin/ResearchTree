...
;
exports.default = (0, createPlot_1.default)(column_1.Column, 'StackedColumnChart', function (props) {
    (0, warning_1.default)(false, '<StackedColumnChart />即将在5.0中废弃，请使用<ColumnChart />替代。');
