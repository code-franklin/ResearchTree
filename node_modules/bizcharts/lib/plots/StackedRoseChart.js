...
var polyfill = function (opt) {
    (0, warning_1.default)(false, '<StackedRoseChart /> 即将在5.0后废弃，请使用<RoseChart />替代，');
    ...
    if ((0, get_1.default)(options, 'label.type') === 'inner') {
        options.label.offset = -15;
        delete options.label.type;
    }
    if ((0, get_1.default)(options, 'label.type') === 'outer') {
        delete options.label.type;
    }
    return __assign(__assign({}, options), { isStack: true });
};
exports.default = (0, createPlot_1.default)(rose_1.Rose, 'StackedRoseChart', polyfill);
