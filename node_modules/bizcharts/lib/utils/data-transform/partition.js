...
function partition(rows, group_by, order_by) {
    ...
    var groupingFn;
    if ((0, is_function_1.default)(group_by)) {
        groupingFn = group_by;
    }
    else if ((0, is_array_1.default)(group_by)) {
    ...
    else if ((0, is_string_1.default)(group_by)) {
        groupingFn = function (row) { return "_".concat(row[group_by]); };
    }
    var groups = (0, group_by_1.default)(newRows, groupingFn);
    return groups;
}
;
