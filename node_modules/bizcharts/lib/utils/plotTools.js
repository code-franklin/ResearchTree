...
var visibleHelper = function (cfg, defaultVisible) {
    if (defaultVisible === void 0) { defaultVisible = true; }
    if ((0, is_string_1.default)(cfg) || react_1.default.isValidElement(cfg)) {
        return {
            visible: true,
            text: cfg,
        };
    }
    if ((0, is_boolean_1.default)(cfg)) {
        return {
            visible: cfg,
        };
    }
    if ((0, is_object_1.default)(cfg)) {
...
var visibleHelperInvert = function (cfg) {
    // @ts-ignore
    if ((0, is_object_1.default)(cfg) && cfg.visible !== false) {
        // @ts-ignore
        return cfg.text;
    }
    return cfg;
